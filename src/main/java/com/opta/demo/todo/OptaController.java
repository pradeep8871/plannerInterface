...
public final class OptaController {
    ...
    @Autowired GraphHopperService graphHopperService;
    @Autowired KieService optaPlannerService;
    ...
    Map<String ,Object> getStatus(@RequestParam String id) {
    	return ResponseHandler.generateResponse("save Data sucessFully", HttpStatus.ACCEPTED, false, optaservice.getPlanningProblemByid(id));
    }
        
    @RequestMapping(value = "/getSolution", method = RequestMethod.GET)
    Map<String ,Object> getSolution(@RequestParam String id) {
    	return ResponseHandler.generateResponse("save Data sucessFully", HttpStatus.ACCEPTED, false, optaservice.getSolutionById(id));
    }
    ...
    Map<String ,Object> makeKieContainer() {
    	optaPlannerService.makeKieContainer();
    	return ResponseHandler.generateResponse("save Data sucessFully", HttpStatus.ACCEPTED, false, null);
    }*/
